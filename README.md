...
Event browsing: list events, filter/search, view details

Event creation by authenticated users: title, description, date/time, location, capacity

Registration: users can register/unregister for events

Attendee management: event creators can view list of attendees
